...
import net.cassite.style.control.Return;
...
public class Supportters extends Style {
	...
	public static class ArrayFuncSup<T> {
		...
		public <R> R forEach(Void1ArgInterface<T> func) {
			return forEach($(func));
		}

		public <R> R forEach(Void2ArgInterface<T, IteratorInfo> func) {
			return forEach($(func));
		}
		...
		@SuppressWarnings("unchecked")
		public <R> R forThose(Predicate<T> predicate, Void1ArgInterface<T> func) {
			return (R) forThose(predicate, $(func));
		}

		@SuppressWarnings("unchecked")
		public <R> R forThose(Predicate<T> predicate, Void2ArgInterface<T, IteratorInfo> func) {
			return (R) forThose(predicate, $(func));
		}
				...
				try {
					...
					if (throwable instanceof StyleRuntimeException) {
						...
						if (origin instanceof Break) {
							...
							continue;
						} else if (origin instanceof Return) {
							res = (R) ((Return) origin).getRes();
	...
	public static class ListFuncSup<T> extends CollectionFuncSup<T> {
		...
		public <R> R forEach(Void1ArgInterface<T> func, int index) {
		...
		@SuppressWarnings("unchecked")
		public <R> R forThose(Predicate<T> predicate, Void1ArgInterface<T> func, int index) {
		...
		@SuppressWarnings("unchecked")
		public <R> R forThose(Predicate<T> predicate, Void2ArgInterface<T, IteratorInfo> func, int index) {
			return (R) forThose(predicate, $(func), index);
		}
	...
	public static class MapFuncSup<K, V> {
		...
		public Object forEach(Void2ArgInterface<K, V> func) {
		...
		public <R> R forThose(R2ArgsInterface<Boolean, K, V> predicate, Void2ArgInterface<K, V> func) {
			return (R) forThose(predicate, Style.$(func));
		}

		public <R> R forThose(R2ArgsInterface<Boolean, K, V> predicate, Void3ArgInterface<K, V, IteratorInfo> func) {
			return (R) forThose(predicate, Style.$(func));
		}

		@SuppressWarnings("unchecked")
		public <R> R forThose(R2ArgsInterface<Boolean, K, V> predicate, def<R> func) {
