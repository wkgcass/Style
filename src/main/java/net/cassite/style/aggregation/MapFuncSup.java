...
public class MapFuncSup<K, V> {
         ...
         * @param func      a function takes in each element from map
         * @return return 'last loop value'.<br>
         * check
         * <a href="https://github.com/wkgcass/Style/">tutorial</a> for
         * more info about 'last loop value'
         ...
         *
         * @param key   key of the entry to put
         * @param value value of the entry to put
         ...
         *
         * @param <K>    key type of entry to transform
         * @param <V>    value type of entry to transform
         * @param <R>    element type of the collection to transform to
        ...
        public static class TransformerColl<K, V, R, Coll extends Collection<R>> {
                 ...
                 *
                 * @param method a function takes in each entry from the map
        ...
        public <R, Coll extends Collection<R>> TransformerColl<K, V, R, Coll> to(Coll collection) {
                return new TransformerColl<>(map, collection);
        }
        ...
        public <R> TransformerArr<K, V, R> to(R[] arr) {
                return new TransformerArr<>(map, arr);
        }

        /**
         * Transforms a map into another one
         *
         * @param <K>  key type of the map to transform
         * @param <V>  value type of the map to transform
         * @param <K2> key type of the map to transform to
         * @param <V2> value type of the map to transform to
         * @param <M>  the map to transform to
         * @author wkgcass
         */
        ...
        public <K2, V2, M extends Map<K2, V2>> TransformerMap<K, V, K2, V2, M> to(M m) {
                return new TransformerMap<>(map, m);
        }
        ...
        public Entry<K, V> findOne(def<Boolean> filter) {
                return Aggregation.$(findAll(filter, new HashMap<>(), 1)).first();
        }
        ...
        public Map<K, V> findAll(def<Boolean> filter) {
                return findAll(filter, new HashMap<>());
        }
         ...
         *               which takes in each entry in map and returns
         *               true/false/null
         * @param map    the map to put entries to
         * @return all matched entries in a HashMap
         */
