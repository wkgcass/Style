 ...
 * @param <ObjectType> type of class this field resolves to
 * @author wkgcass
 */
public class FieldSupport<FieldType, ObjectType> implements MemberSup<Field> {
        ...
        /**
         * @param f      field to support
         * @param cls    field type
         * @param objCls resolved object's type
         */
         ...
         *
         * @param obj object from which the represented field's value is to
         *            be extracted
