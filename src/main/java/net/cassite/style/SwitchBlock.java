 ...
 *
 * @param <T> type of the object to switch
 * @param <R> type of the return value of switch-expression
 * @author wkgcass
 */
public class SwitchBlock<T, R> {
         ...
         * @param func function to apply when matches and return a result for
         ...
         *
         * @param func function to apply when all cases are not matched and
         ...
         * and return the result
         *
         * @param func function to apply when all cases are not matched
         * @return result obj
         */
        @SuppressWarnings("unchecked")
